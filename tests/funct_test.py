...
class FunctionsTests(unittest.TestCase):
    ...
    def test_collusion(self):
        ...
        cactus_arr = [
            Dng.Object(Dng.usr_x, 449, 64, None, 5),
            Dng.Object(300, 449, 64, None, 5),
            Dng.Object(600, 449, 64, None, 5),
        ]
        self.assertTrue(Dng.check_collision(cactus_arr))

    def test_collusion_wrong(self):
        # """Test collusion function."""
        # Run into small cactus
        cactus_arr = [
            Dng.Object(Dng.usr_x, 44110423432, 64, None, 5),
            Dng.Object(300, 449, 64, None, 5),
            Dng.Object(600, 449, 64, None, 5),
        ]
        ...
        cactus_arr = [
            Dng.Object(Dng.usr_x + 50, 44936363, 64, None, 5),
            Dng.Object(300, 44, 64, None, 5),
            Dng.Object(600, 449, 64, None, 5),
        ]
        self.assertFalse(Dng.check_collision(cactus_arr))

        cactus_arr = [
            Dng.Object(Dng.usr_x + 50234242, 410, 37, None, 5),
            Dng.Object(300, 40, 37, None, 5),
            Dng.Object(600, 410, 37, None, 5),
        ]
        self.assertFalse(Dng.check_collision(cactus_arr))

        cactus_arr = [
            Dng.Object(Dng.usr_x + 50, 42643463, 40, None, 5),
            Dng.Object(300, 20, 40, None, 5),
    ...
    def test_health_wrong(self):
        # """Test check_health function."""
        Dng.health = 10

        self.assertTrue(Dng.check_health())
        self.assertNotEqual(4, Dng.health)
    ...
    def test_jump(self):
        ...
        jump_tries = {
            ...
            14: 256.0,
            13: 250.4,
            12: 245.20000000000002,
            11: 240.4,
            10: 236.0,
            9: 232.0,
            8: 228.4,
            7: 225.20000000000002,
            6: 222.4,
            5: 220.0,
            4: 218.0,
            3: 216.4,
            2: 215.20000000000002,
            1: 214.4,
            0: 214.0,
            -1: 214.0,
            -2: 214.4,
            -3: 215.20000000000002,
            -4: 216.4,
            -5: 218.0,
            -6: 220.0,
            -7: 222.4,
            -8: 225.20000000000002,
            -9: 228.4,
            -10: 232.0,
            -11: 236.0,
            -12: 240.4,
            -13: 245.20000000000002,
            -14: 250.4,
            -15: 256.0,
            -16: 262.0,
            -17: 268.4,
    ...
    def test_scores(self):
        ...
        Dng.jump_counter = -30
        cactus_arr = [
            Dng.Object(Dng.usr_x - 20, 449, 64, None, 5),
            Dng.Object(300, 449, 64, None, 5),
            Dng.Object(600, 449, 64, None, 5),
        ]
